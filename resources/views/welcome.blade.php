     ...
     <div class="layout overflow-hidden">
        ...
        >
            ...
            >
                ...
                <li
                    class="nav-item d-none d-xl-block invisible flex-xl-grow-1"
                >
                ...
                <li class="nav-item">
                    <a
                        class="nav-link active py-0 py-lg-8"
                        id="tab-chats"
                ...
                <li class="nav-item">
                    ...
                    >
                        <div
                            class="avatar avatar-online mx-auto d-none d-xl-block"
                        >
                            <img
                                class="avatar-img"
                        ...
                        <div
                            class="avatar avatar-online avatar-xs d-xl-none"
                        >
                            <img
                                class="avatar-img"
                                src="assets/img/avatars/1.jpg"
                                ...
                                <div class="tab-content" role="tablist">
                                    ...
                                    >
                                        <div class="card border-0">
                                            <div class="profile">
                                                <div
                                                    class="profile-img text-primary rounded-top"
                                                >
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        fill="currentColor"
                                        ...
                                        <div
                                            class="d-flex align-items-center mt-4 px-6"
                                        >
                                            <small
                                                class="text-muted me-auto"
                                                >Enter chat name and add an
                                                optional photo.</small
                                            >
                                        </div>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="d-flex align-items-center" >
                                                            <div class="line-clamp me-auto" >
                                                                {{ $user->conversations->theMessage->body }}
                                                           </div>
                                                            <div class="badge badge-circle bg-primary ms-5" ><span>3</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <div class="card-list">
                                    <!-- Title -->
                                    <div
                                        class="d-flex align-items-center my-4 px-6"
                                    >
                                            ...
                                            <div class="row gx-5">
                                                ...
                                                <div class="col">
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            class="extra-small text-muted ms-2"
                                                            >08:45 PM</span
                                                        >
                                                    </div>
                            ...
                            <div class="container py-8">
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <label
                                                                        class="form-check-label"
                                                                        for="accordion-security-check-1"
                                                                    ></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="mt-8">
                                    ...
                                    >
                                        ...
                                        <div
                                            class="flex align-items-center text-muted"
                                        >
                                            <a
                                                href="#"
                                            ...
                                            >
                                                <li class="list-group-item">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <span
                                                                class="text-primary extra-small"
                                                                >active</span
                                                            >
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-8 col-xl-12">
                                ...
                                >
                                    ...
                                    <div class="col-xl-6 d-none d-xl-block">
                                        <div
                                            class="row align-items-center justify-content-end gx-6"
                                        >
                                            <div class="col-auto">
                                                <a
                                                    href="#"
        ...
        <!-- Chat: Info -->
        <div
            class="offcanvas offcanvas-end offcanvas-aside"
            data-bs-scroll="true"
        ...
        >
            ...
            <div class="offcanvas-header py-4 py-lg-7 border-bottom">
                ...
                <div
                    class="visibility-xl-invisible overflow-hidden text-center"
                >
            ...
            <div class="offcanvas-body hide-scrollbar">
                ...
                <div class="tab-content py-2" role="tablist">
                    ...
                    >
                        ...
                        <ul
                            class="list-group list-group-flush border-top mt-8"
                        >
                            <li class="list-group-item">
                                <div class="row align-items-center gx-6">
                                    <div class="col">
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check form-switch">
                                            ...
                                            <label
                                                class="form-check-label"
                                                for="accordion-security-check-5"
                                            ></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="list-group-item">
                                <div class="row align-items-center gx-5">
                                    ...
                                    <div class="col overflow-hidden">
                                        <h5 class="text-truncate">
                                            <a href="#"
                                                >E5419783-047D-4B4C-B30E-F24DD8247731.JPG</a
                                            >
                                        </h5>
